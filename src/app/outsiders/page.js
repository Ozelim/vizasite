    ...
    <div aria-hidden="true" style={{
      ...
      <div style={{ position: "absolute", top: 0, left: 0, width: "100%", height: `${bands * 100}vh` }}>
        {Array.from({ length: bands }).map((_, i) => {
          ...
          return (
            <div key={i} style={{ position: "absolute", top: `${i * 100}vh`, left: 0, width: "100%", height: "100vh", overflow: "hidden" }}>
...
function VisaCard({ icon: Icon, title, codes, desc }) {
  return (
    ...
    >
      ...
      <div className="w-12 h-12 rounded-xl flex items-center justify-center shrink-0 mt-0.5" style={iconBg}>
        <Icon size={22} style={{ color:"#a855f7" }} />
      </div>
      <div className="min-w-0">
        <p className="font-bold text-base mb-1" style={gradStyle}>{title}</p>
        {codes && <p className="text-sm text-slate-600 mb-1 leading-relaxed">{codes}</p>}
...
function WhyCard({ title, desc }) {
  return (
    ...
    >
      <div className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0 mt-0.5" style={iconBg}>
...
function GuaranteeCard({ icon: Icon, title, desc }) {
  return (
    <div
      ...
      onMouseLeave={e=>{ e.currentTarget.style.borderColor="rgba(220,167,242,.2)"; e.currentTarget.style.boxShadow=cardShadow; e.currentTarget.style.transform="translateY(0)"; }}
    >
      <div className="w-12 h-12 rounded-xl flex items-center justify-center mb-5" style={iconBg}>
        <Icon size={24} style={{ color:"#a855f7" }} />
      </div>
      <h3 className="font-bold text-base mb-2" style={gradStyle}>{title}</h3>
        ...
        <section className="py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div
              ...
              style={{ borderColor:"rgba(220,167,242,.2)", boxShadow:cardShadow, background:"rgba(255,255,255,.75)", backdropFilter:"blur(8px)" }}
            >
              {/* photo */}
              <div className="relative w-full md:w-5/12 min-h-[380px]">
                ...
                />
                {/* name badge */}
                <div className="absolute bottom-6 left-6 right-6 md:right-auto md:translate-x-0 rounded-2xl px-5 py-4"
                  style={{ background:"linear-gradient(135deg,#dca7f2,#a855f7,#7c3aed)", boxShadow:"0 8px 32px rgba(168,85,247,.4)" }}>
                  <p className="font-bold text-white text-lg">Мукатаева Айгуль</p>
                  <p className="text-white text-sm">Директор офиса</p>
                  <p className="text-white text-sm mt-0.5">опыт работы более 20 лет</p>
                </div>
              </div>
              ...
              <div className="w-full md:w-7/12 p-8 md:p-12 flex flex-col justify-center">
                <p className="text-slate-700 leading-relaxed mb-6">
                  <span className="font-semibold" style={{ color:"#a855f7" }}>Наш визовый центр</span>{" "}
                  помогает иностранным гражданам оформить документы для проживания и работы в Казахстане.
                  Мы объясним весь процесс и поможем подготовить документы.
                </p>

                {/* services list */}
                <div className="rounded-2xl p-6 border" style={{ borderColor:"rgba(220,167,242,.2)", background:"rgba(220,167,242,.05)" }}>
                  <p className="font-bold text-sm uppercase tracking-widest mb-4" style={{ color:"#a855f7" }}>Мы помогаем с:</p>
                ...
                <p className="mt-6 font-semibold text-sm" style={{ color:"#a855f7" }}>
                  Обращайтесь — будем рады помочь! 🤝
                </p>
              </div>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              ...
              <VisaCard
                ...
                codes={<><strong>A1</strong> — главы государств и делегации · <strong>A2</strong> — сотрудники дипмиссий · <strong>A3</strong> — представители иностранных государств</>}
                desc="Официальный въезд для дипломатической и служебной деятельности."
              />
              <VisaCard
                icon={TrendingUp}
                title="Инвестиционные визы"
                codes={<><strong>B1</strong> — инвесторы и представители инвесткомпаний</>}
                desc="Для привлечения иностранных инвестиций и ведения инвестиционной деятельности."
              />
              <VisaCard
                icon={Building2}
                title="Бизнес-визы"
                codes={<><strong>B2</strong> — деловые встречи и конференции · <strong>B3</strong> — установка оборудования и услуги</>}
                desc="Краткосрочные деловые визиты без оформления трудоустройства."
              />
              <VisaCard
                icon={PlaneTakeoff}
                title="Туристические визы"
                codes={<><strong>B12</strong> — краткосрочные туристические поездки</>}
                desc="Туризм, экскурсии, отдых и изучение достопримечательностей Казахстана."
              />
              <VisaCard
                icon={Stethoscope}
                title="Визы на лечение и частные визиты"
                codes={<><strong>B10</strong> — лечение · <strong>B11</strong> — частный визит к родственникам</>}
                desc="Медицинские услуги, посещение друзей и родственников."
              />
              <VisaCard
                icon={GraduationCap}
                title="Студенческие и учебные визы"
                codes={<><strong>C9</strong> — учёба в вузах, колледжах, образовательных учреждениях</>}
                desc="Для поступающих на программы высшего, среднего и дополнительного образования."
              />
              <VisaCard
                icon={Briefcase}
                title="Рабочие визы"
                codes={<><strong>C3</strong> — прибытие на работу · <strong>C4, C5, C6</strong> — различные категории и сезонные работы</>}
                desc="Официальное трудоустройство и разрешение на работу в Казахстане."
              />
              <VisaCard
                icon={Users}
                title="Визы на воссоединение семьи"
                codes={<><strong>C2</strong> — члены семьи иностранных граждан, проживающих в РК</>}
                desc="Для воссоединения супругов, детей и близких родственников."
              />
              <VisaCard
                icon={HomeIcon}
                title="Визы для ПМЖ"
                codes={<><strong>C10</strong> — для лиц с разрешением на постоянное место жительства</>}
            ...
            <div className="flex flex-col md:flex-row gap-12 items-start">
              ...
              <div className="shrink-0 md:sticky md:top-24">
                <div className="rounded-2xl px-8 py-6 relative overflow-hidden"
                  style={{ background:"linear-gradient(135deg,#dca7f2,#a855f7,#7c3aed)", boxShadow:"0 8px 32px rgba(168,85,247,.35)", minWidth:200 }}>
                  ...
                  <h2 className="text-3xl font-bold text-white whitespace-nowrap relative z-10"
              ...
              <div className="grid sm:grid-cols-2 gap-5 flex-1">
                <WhyCard title="Глубокая экспертиза"       desc="Специализируемся исключительно на миграционном законодательстве Казахстана и знаем все его нюансы." />
                <WhyCard title="10+ лет опыта"             desc="С 2014 года помогли более 12 000 иностранным гражданам оформить документы для легального проживания и работы." />
                <WhyCard title="Гарантированный результат" desc="Заключаем официальный договор и берём на себя полную ответственность за успешное принятие документов госорганами." />
                <WhyCard title="Прозрачные условия"        desc="Стоимость фиксируется в договоре с самого начала и не меняется до получения РВП, ВНЖ или гражданства." />
                <WhyCard title="Честные консультации"      desc="Предоставляем только объективную информацию о вашей ситуации, не предлагая ненужных услуг." />
                <WhyCard title="Полное сопровождение"      desc="Помогаем не только с консультациями, но и с подготовкой всех документов для получения законного статуса." />
                <WhyCard title="Персональный подход"       desc="Наши юристы сопровождают вас на всех этапах, взаимодействуют с госорганами и решают возникающие вопросы." />
                <WhyCard title="Комфортная коммуникация"   desc="Работаем на русском, казахском и английском языках. Переводчик на другой язык — организуем по запросу." />
              </div>
            </div>
          </div>
        </section>
